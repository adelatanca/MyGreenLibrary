      ...
      <div class="collapse navbar-collapse" id="collapsibleNavbar">
        ...
        <div class="d-flex justify-content-center">
            <form action="" method="post" class="w-50">
                ...
                <div class="pt-2">
                    <?php inputElement("<i class='fas fa-address-card'></i>","Id autor", "id_autor",""); ?>
                </div>
                <div class="pt-2">
                    <?php inputElement("<i class='fas fa-file-signature'></i>","Nume autor", "nume_autor",""); ?>
                </div>
                <div class="pt-2">
                    <?php inputElement("<i class='fas fa-file-signature'></i>","Prenume autor", "prenume_autor",""); ?>
                </div>              
                <div class="row pt-2">
                    <div class="col">
                        <?php inputElement("<i class='fas fa-quote-right'></i>","Gen autor", "gen",""); ?>
                    </div>                  
                </div>
                       ...
                       if($result){
                           ...
                           while ($row = mysqli_fetch_assoc($result)){ ?>
                               <tr>                                
                                   ...
                                   <td ><i class="fas fa-edit btnedit" data-id="<?php echo $row['id_autor']; ?>"></i></td>
                               </tr>
...
<script src="../BibliotecaTancaAdela/php/autor.js"></script>
