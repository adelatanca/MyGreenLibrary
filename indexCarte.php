      ...
      <div class="collapse navbar-collapse" id="collapsibleNavbar">
        ...
        <div class="d-flex justify-content-center">
            <form action="" method="post" class="w-50">
                ...
                <div class="pt-2">
                    <?php inputElement("<i class='fas fa-book'></i>","ISBN", "isbn",""); ?>
                </div>
                <div class="pt-2">
                    <?php inputElement("<i class='fas fa-quote-right'></i>","Titlu", "titlu",""); ?>
                </div>
                <div class="pt-2">
                    <?php inputElement("<i class='fas fa-file'></i>","Editura", "editura",""); ?>
                </div>              
                <div class="row pt-2">
                    <div class="col">
                        <?php inputElement("<i class='fas fa-plus'></i>","Nr exemplare", "nr_exemplare",""); ?>
                    </div>
                    <div class="col">
                        <?php inputElement("<i class='fas fa-align-justify'></i>","Categorie", "categorie",""); ?>
                    </div>
                </div>
                       ...
                       if($result){
                           ...
                           while ($row = mysqli_fetch_assoc($result)){ ?>
                               <tr>                                
                                   ...
                                   <td ><i class="fas fa-edit btnedit btneditC" data-id="<?php echo $row['isbn']; ?>"></i></td>
                               </tr>
...
<script src="../BibliotecaTancaAdela/php/carte.js"></script>
