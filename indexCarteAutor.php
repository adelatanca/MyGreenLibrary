...
require_once ("../BibliotecaTancaAdela/php/operationCarteAutor.php");
?>
...
<main >
  ...
  <div class="d-flex justify-content-center">
            ...
            <div class="row pt-2">
                <div class="col">
                    <?php inputElement("<i class='fas fa-address-card'></i>","Id_status_cartea", "id",""); ?>
                </div>
                <div class="col">
                    <?php inputElement("<i class='fas fa-file-signature'></i>","Cartea_ISBN", "cartea_isbn",""); ?>
                </div>
                <div class="col">
                    <?php inputElement("<i class='fas fa-file-signature'></i>","Autorul_id_autor", "autorul_id_autor",""); ?>
                </div>              
              
               </div>
                <div class="d-flex justify-content-center">
                        <?php buttonElement("btn-createCA","btn btn-success","<i class='fas fa-plus'></i>","createCA","data-toggle='tooltip' data-placement='bottom' title='Create'"); ?>
                        <?php buttonElement("btn-readCA","btn btn-primary","<i class='fas fa-sync'></i>","readCA","data-toggle='tooltip' data-placement='bottom' title='Read'"); ?>
                        <?php buttonElement("btn-updateCA","btn btn-light border","<i class='fas fa-pen-alt'></i>","updateCA","data-toggle='tooltip' data-placement='bottom' title='Update'"); ?>
                        <?php buttonElement("btn-deleteCA","btn btn-danger","<i class='fas fa-trash-alt'></i>","deleteCA","data-toggle='tooltip' data-placement='bottom' title='Delete'"); ?>
                        <?php deleteBtnAutor();?>
                </div>
            </form>
        </div>
                   ...
                   if(isset($_POST['readCA'])){
                       ...
                       if($result1){
                           ...
                           while ($row1 = mysqli_fetch_assoc($result1)){ ?>
                               <tr>                                
                                   <td data-id="<?php echo $row1['id']; ?>"><?php echo $row1['id']; ?></td>
                                   <td data-id="<?php echo $row1['id']; ?>"><?php echo $row1['cartea_isbn']; ?></td>
                                   <td data-id="<?php echo $row1['id']; ?>"><?php echo $row1['autorul_id_autor']; ?></td>                                                                    
                                  
                                   <td ><i class="fas fa-edit btnedit" data-id="<?php echo $row1['id']; ?>"></i></td>
                               </tr>
                   <?php
                           }
...
<script src="../BibliotecaTancaAdela/php/carte_autor.js"></script>
</body>
</html>