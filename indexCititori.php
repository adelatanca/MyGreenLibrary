      ...
      <div class="collapse navbar-collapse" id="collapsibleNavbar">
        ...
        <div class="d-flex justify-content-center">
            <form action="" method="post" class="w-50">
                ...
                <div class="pt-2">
                    <?php inputElement("<i class='fas fa-address-card'></i>","Id cititor", "id_cititor",""); ?>
                </div>
                <div class="pt-2">
                    <?php inputElement("<i class='fas fa-file-signature'></i>","Nume cititor", "nume_cititor",""); ?>
                </div>
                <div class="pt-2">
                    <?php inputElement("<i class='fas fa-file-signature'></i>","Prenume cititor", "prenume_cititor",""); ?>
                </div>     
                <div class="pt-2">
                    <?php inputElement("<i class='fas fa-phone'></i>","Nr. telefon", "nr_telefon",""); ?>
                </div> 
                <div class="pt-2">
                ...
                <div class="d-flex justify-content-center">
                        ...
                        <?php deleteBtnCititor();?>
                </div>
            </form>
        </div>
        <h3 class="center"> Cititori </h3>
                       ...
                       if($result){
                           ...
                           while ($row = mysqli_fetch_assoc($result)){ ?>
                               <tr>                                
                                   ...
                                   <td data-id="<?php echo $row['id_cititor']; ?>"><?php echo $row['nume_cititor']; ?></td>
                                   <td data-id="<?php echo $row['id_cititor']; ?>"><?php echo $row['prenume_cititor']; ?></td>                                  
                                   <td data-id="<?php echo $row['id_cititor']; ?>"><?php echo $row['nr_telefon']; ?></td>
                                   <td data-id="<?php echo $row['id_cititor']; ?>"><?php echo $row['email']; ?></td>
                                  
                                   <td ><i class="fas fa-edit btnedit" data-id="<?php echo $row['id_cititor']; ?>"></i></td>
                               </tr>
                   <?php
                           }
...
<script src="../BibliotecaTancaAdela/php/cititori.js"></script>
</body>
</html>